...
const MOOD_OPTIONS = [
	...
	{
		label: "😢 Hit me in the feels",
		value: "emotional, heartwarming or tearjerker",
	},
	{ label: "⚔️ Epic action", value: "intense battles and high stakes action" },
	{
		label: "💞 Wholesome romance",
		value: "sweet romance and heartfelt connections",
	},
	{
		label: "😰 Keep me on edge",
		value: "suspense, mystery and psychological tension",
	},
	{ label: "🌸 Chill & cozy", value: "relaxing, peaceful slice-of-life vibes" },
	{
		label: "🚀 Adventurous journey",
		value: "grand adventure and world exploration",
	},
];
...
export default function TasteQuizModal({
	...
	const steps = [
		{ title: "What genres do you love?", subtitle: "Pick as many as you like" },
		{
			...
			subtitle: "Choose the feeling you want",
		},
		{
			title: "Anime you've already loved",
			subtitle: "Name up to 3 favourites (optional)",
		},
	];
						...
						{step === 2 && (
							...
							>
									...
									<div key={idx} className="relative">
										...
										<div className="relative flex items-center">
											...
											<button
												...
												disabled={
													!animeInput[idx].trim() || searchLoading === idx
												}
								...
								<p className="text-white/25 text-xs">
									💡 Type an anime name and click 🔍 to search
								</p>
							</motion.div>
						)}
					</AnimatePresence>
