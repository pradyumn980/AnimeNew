...
const PRODUCT_DEFS: Omit<Product, "image">[] = [
	// Posters
	{
		...
		description: "High-quality A2 glossy print, fade-resistant ink.",
	},
	{
		id: "poster-2",
		...
		description: "Vibrant art print perfect for any anime room.",
		tag: "Popular",
	},
	{
		id: "poster-3",
		...
		description: "Classic wanted-poster style, frame-ready.",
	},
	// Hoodies
	{
		id: "hoodie-1",
		...
		jikanId: 20,
		animeTitle: "Naruto",
		description: "350 GSM fleece, embroidered logo, unisex fit.",
	},
	{
		id: "hoodie-2",
		...
		description: "Minimal design, double-stitched hems, ultra-soft.",
		tag: "Best Seller",
	},
	{
		id: "hoodie-3",
		...
		description: "Full-color print, kangaroo pocket, Plus Ultra!",
	},
	// Figurines
	{
		id: "fig-1",
		...
		description: "18 cm PVC, hand-painted, display base included.",
		tag: "Limited",
	},
	{
		id: "fig-2",
		...
		jikanId: 16498,
		animeTitle: "Shingeki no Kyojin",
		description: "20 cm poseable figure, interchangeable blades.",
	},
	{
		id: "fig-3",
		...
		description: "Collector's edition, 22 cm, acrylic stand.",
	},
];
...
async function fetchJikanImages(
	ids: number[],
...
export default function Shop() {
	...
	const [products, setProducts] = useState<Product[]>(
		PRODUCT_DEFS.map((p) => ({ ...p, image: undefined })),
	);
		...
		<div className="min-h-screen bg-gradient-to-b from-black via-[#0f172a] to-[#1a0010] px-4 py-12">
			...
			<div className="text-center mb-10">
				...
				<p className="text-white/50 text-lg">
					Posters · Hoodies · Figurines — delivered to your door.
				</p>
				{imagesLoading && (
					<p className="text-white/30 text-sm mt-2 flex items-center justify-center gap-1.5">
						<Loader2 className="w-3.5 h-3.5 animate-spin" /> Fetching anime
						artwork…
					</p>
				)}
			</div>
						...
						>
							...
							<div className="flex items-center justify-between p-5 border-b border-white/10">
								<h2 className="text-white font-bold text-lg flex items-center gap-2">
									<ShoppingCart className="w-5 h-5 text-red-400" /> Cart (
									{cartCount})
								</h2>
								<button
									type="button"
								...
								{cart.map((item) => (
									...
									>
										{item.image ? (
											...
											<div className="w-14 h-14 rounded-lg bg-white/10 shrink-0 flex items-center justify-center text-2xl">
												🎴
											</div>
										)}
										...
										<div className="flex items-center gap-2 shrink-0">
											<button
												...
												className="w-7 h-7 bg-white/10 rounded-lg flex items-center justify-center text-white hover:bg-red-500/30 transition-colors"
											>
