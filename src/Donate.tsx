			...
			<div className="w-full max-w-lg">
				...
				>
					...
					<div className="bg-pink-500/5 border border-pink-500/20 rounded-xl p-4">
						<p className="text-pink-300 text-sm font-medium mb-2 flex items-center gap-1.5">
							<Coffee className="w-4 h-4" /> Your support helps with:
						</p>
					...
					>
						{loading ? (
							...
							<>
								<Heart className="w-5 h-5 fill-white" /> Support with ₹
								{finalAmount || "…"}
							</>
						)}
					</button>
